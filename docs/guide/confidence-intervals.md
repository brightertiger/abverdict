...
abverdict uses the **Wilson score interval**, which is more accurate than the normal approximation for:
- Small samples
- Rates near 0% or 100%

### For Numeric Metrics

abverdict uses the **t-distribution**, which accounts for uncertainty in the standard deviation estimate.
